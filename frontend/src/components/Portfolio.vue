          ...
          <div class="upper-row clearfix">
            ...
            <div class="filters clearfix">
              <div class="filter-tabs filter-btns clearfix">
                ...
                <li type="button" class="filter" data-filter=".wedevelopment">
                  Web development
                </li>
                    ...
                    <div class="inner-box">
                      ...
                      <div class="cap-box">
                        <div class="cap-inner">
                          ...
                          <div class="title">
                            <h5>
                              <p class="text-white">E-Commerce tet</p>
                            </h5>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="inner-box">
                      ...
                      <div class="cap-box">
                        <div class="cap-inner">
                          ...
                          <div class="title">
                            <h5>
                              <p class="text-white">Online Stores</p>
                            </h5>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="inner-box">
                      ...
                      <div class="cap-box">
                        <div class="cap-inner">
                          ...
                          <div class="title">
                            <h5>
                              <p class="text-white">Health Care</p>
                            </h5>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="inner-box">
                      ...
                      <div class="cap-box">
                        <div class="cap-inner">
                          ...
                          <div class="title">
                            <h5>
                              <p class="text-white">Online Lessons</p>
                            </h5>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="inner-box">
                      ...
                      <div class="cap-box">
                        <div class="cap-inner">
                          ...
                          <div class="title">
                            <h5>
                              <p class="text-white">Job Portal</p>
                            </h5>
                          </div>
                        </div>
                      </div>
