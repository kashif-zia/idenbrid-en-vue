<template>
    <div>
        <pageHeader title="PAKISTAN DEVELOPMENT" />
        <main>
            <section class="system-sec auto-container mt-5">
                <h2 class="system-sec__tiile">Pakistan Engineer Resource Development</h2>
                ...
                <ul class="system-sec__contents">
                    ...
                    <li class="system-sec__list"><img src="/images/icons/cost.svg" alt=""
                        ...
                        <p class="system-sec__list__text">
                            We can offer you a significantly lower quote compared to the monthly unit price of Japanese development vendors. However, 
                    ...
                    <li class="system-sec__list"><img src="/images/icons/team-recruitment.svg" alt=""
                        ...
                        <p class="system-sec__list__text">
                            Offshore outsourcing offers benefits beyond cost savings. Hiring and managing a team of Japanese engineers can be expensive, but by outsourcing offshore, we can lease a pre-existing team to handle the project.</p>
                    </li>
                </ul>
            </section>
            <section class="system-sec auto-container">
                ...
                <ul class="system-sec__contents">
                    ...
                    <li class="system-sec__list"><img src="/images/icons/PM.svg" alt=""
                        ...
                        <p class="system-sec__list__text">
                            Offshore development has the advantage of enabling team development, 
                            and with a team of 2-3 or more, the Pakistani project manager can also be involved in the project.</p>
                    </li>
                </ul>
            </section>
            <section class="flow">
                <div class="auto-container">
                    <h3 class="content-title content-title_flow">The flow of offshore development in our lab follows a structured process."</h3>
                    <p class="content-text content-subtitle_flow">
                        We provide lab-based offshore development using Pakistani engineers, 
                        and we can accept development work in response to the latest technologies at a cost-effective price.</p>
                </div>
                <div class="flow__scroll auto-container web-consulting">
                    <ul class="flow__contents">
                        ...
                        <li class="flow__list"><img src="/images/icons/management-amico.svg" alt=""
                            ...
                            <p class="flow__list__text">
                                We will always communicate with our PM and the client's personnel to confirm the time schedule and specifications, and how we can improve the development process.
                            </p>
                        </li>
                    </ul>
                </div>
